  ...
  return (
    <Container>
      <Row>
        ...
        <Col xs={12} lg={6} className="mt-4 mt-lg-0 d-flex align-items-center">
          <Container>
          ...
          <Container>
            ...
            >
              <ListGroup className="my-2">
                ...
                <ListGroup.Item>
                  12/06/2019 – Criação de apresentações com impacto I – Jorge
                  Vaz
                </ListGroup.Item>
                <ListGroup.Item>
                  19/06/2019 - Criação de apresentações com impacto II – Jorge
                  Vaz
                </ListGroup.Item>
                <ListGroup.Item>
                ...
                <ListGroup.Item>
                  3/07/2019 – O vídeo como ferramenta pedagógica II – Paulo
                  Alves
                </ListGroup.Item>
                <ListGroup.Item>
                  3/07/2019 – O vídeo como ferramenta pedagógica II – Paulo
                ...
                <ListGroup.Item>
                  4/02/2020 - Oficinas Colaborativas - Testes Online - Paulo
                  Alves e João Ribeiro
                </ListGroup.Item>
                <ListGroup.Item>
