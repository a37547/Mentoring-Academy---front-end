        ...
        <Row>
          ...
          <Col className="mt-3 text-center text-lg-left" sm={12} lg={6}>
            ...
            <ListGroup>
              ...
              <ListGroup.Item>
                Reconhecer e contrariar o mais precocemente possível, no
                percurso académico, as situações de insucesso académico
              </ListGroup.Item>
              <ListGroup.Item>
              ...
              <ListGroup.Item>
                Aumentar o fluxo bidirecional de informação entre a academia e
                os estudantes
              </ListGroup.Item>
              <ListGroup.Item>
