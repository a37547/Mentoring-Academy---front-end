...
const ComoChegar = () => {
  return (
    <React.Fragment>
      <Row>
        <Col xs={12} md={6}>
          <Image src={mapa_braganca} alt="" />
        </Col>
        <Col xs={12} md={6}>
          <h2>Como chegar</h2>
          <p>
            Bragança dispõe de bons acessos por estrada a todos os destinos de
            norte a sul do país, assim como da Europa. O acesso faz-se pela A4,
            IP2 e N103, articulando-se estes com outros eixos rodoviários
            principais.
          </p>
          <p>
            O IPB possui um moderno campus junto ao centro da cidade de Bragança
            (campus de Santa Apolónia, Alameda de Santa Apolónia 5300-253
            Bragança), onde se situam as escolas: Escola Superior Agrária,
            Escola Superior de Educação e Escola Superior de Tecnologia e de
            Gestão e também os Serviços Centrais e os Serviços de Ação Social.
          </p>

          <p>
            A Escola Superior de Saúde de Bragança situa-se junto ao Hospital de
            Bragança, a cerca de 600 m do Campus do IPB.
          </p>
      ...
      <Row>
        <Col xs={12} md={6}>
          ...
          <p>
            ...
            paragem é na estação rodoviária, no centro da cidade. A paragem em
            frente ao IPB é só para chegadas, as partidas são sempre da estação
            rodoviária
          </p>
          ...
          <p>
            O serviço de transportes públicos da cidade é o STUB (autocarros de
            cor amarela). Possui uma rede que cobre uma grande parte da cidade
            (linha urbana), assim como as aldeias do concelho. Podes consultar
            os horários e outras informações na página:
          </p>
          <p>
            {" "}
            <a
