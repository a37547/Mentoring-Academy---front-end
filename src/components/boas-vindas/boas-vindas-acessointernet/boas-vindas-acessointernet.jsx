    ...
    <Row>
      <Col xs={12}>
        ...
        <p>
          ...
          corrente ano (Código de Utilizador e Referência), fornecida no acto da
          matrícula.
        </p>
        <p>
          O serviço Myconfig permite também configurar o Correio Electrónico
          (Auto-Resposta e Anti-Spam), Página Pessoal, Alterar Senha de Acesso e
          Partilhar Ficheiros
        </p>
        ...
        <ListGroup>
          <ListGroup.Item>
            ...
            <p> 3. Password: Senha de Acesso à conta de Correio Electrónico</p>
          </ListGroup.Item>
        </ListGroup>
        <ListGroup>
          <ListGroup.Item>
            ...
            <p>
              A configuração para outros sistemas operativos pode ser consultada
              na página dos serviços de informática:{" "}
              <a
        ...
        <p>
          ...
          podes encontrar manuais de ajuda de configuração do cliente de email.
        </p>
        <p>
          É muito importante consultares com frequência o email do IPB, devido a
          serem enviados avisos e informações académicas importantes.
        </p>

        <h4>VPN: Acesso aos serviços fora do IPB</h4>
        <p>
          O Serviço de VPN (Virtual Private Network - Rede Privada Virtual) do
          IPB permite o acesso directo aos Serviços disponibilizados na Rede do
          IPB, a partir de uma ligação externa (por exemplo através de uma
          ligação de um ISP ou através de uma rede e-U de outra instituição de
          ensino superior).
        </p>
        <p>
