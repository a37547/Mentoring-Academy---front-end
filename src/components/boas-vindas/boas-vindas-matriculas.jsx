        ...
        <Col xs={12} className="text-center">
          ...
          <ListGroup className="my-4 text-left">
            ...
            <ListGroup.Item>
              ...
              estudos de licenciatura (todas as licenciaturas da Escola Superior
              de Saúde de Bragança - Pré-requisitos do Grupo A )
            </ListGroup.Item>
          </ListGroup>
          ...
          <p>
            Podes também consultar o calendário escolar específico do teu curso
          ...
          <p>
            ...
            certificados, entre outros assuntos de ordem académica. Para mais
            informaçãoes podes consultar na página dos Serviços Académicos em{" "}
            <a
