...
const AssociacoesEstudantes = () => {
  return (
    <section id="associacoesestudantes" className="section-bg">
          ...
          <div className="row">
            <div className="col-12">
              ...
              >
                ...
                <p>
                  {" "}
                  As associações estudantis organizam diversas atividades
                  académicas, culturais e de integração dos novos alunos que
                  permitem fomentar o espirito académico e o desenvolvimento
                  intelectual dos seus estudantes.
                </p>
                <p>
                  {" "}
                  A Associação Académica do IPB, está organizada em associações
                  de estudantes em cada uma das escolas que constituem o IPB e
                  cada escola possuí Núcleos de Estudantes organizados por
                  curso.
                </p>
                <p>
                  Podes contribuir de forma ativa para o futuro do IPB, ao
                  participares nas diversas atividades promovidas pelas
                  Associações Estudantis do IPB.{" "}
                </p>
                ...
                <ul>
                  <li>
                    <h5>
                      Associação dos Estudantes Africanos em Bragança - AEAB
                    </h5>
                    <a
                  ...
                  <li>
                    <h5>
                      Associação dos Estudantes Brasileiros do IPB - AEBIPB
                    </h5>
                    <a
...
"
                ...
                <p>
                  No IPB existem um conjunto de Tunas e grupos culturais nos
                  quais todos os estudantes podem participar.
                </p>
                <h5>Bragança</h5>
