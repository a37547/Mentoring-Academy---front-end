  ...
  return (
    <Jumbotron>
      <Row className="d-flex justify-content-center">
        <Col xs={12} sm={9} className="d-flex flex-column align-items-center">
          ...
          <Image
            ...
            fluid
          />
          <div id="president-text" className="mt-4 text-justify">
            ...
            <p>
              ...
              sucesso para chegar aqui e estamos muito orgulhosos da escolha que
              fizeram.
            </p>
            <p>
            ...
            <p>
              ...
              certamente que passaram a integrar uma instituição muito especial.
              O Instituto Politécnico mais prestigiado do País, como todos os
              rankings internacionais o demonstram, e uma instituição que, em
              diversas áreas disciplinares, surge entre as melhores do mundo.
              Este reconhecimento internacional é uma garantia do valor do vosso
              futuro diploma, de elevada empregabilidade e de valorização
              pessoal.
            </p>
            <p>
              Mas o IPB é muito mais do que apenas uma boa escola de formação: é
              uma instituição que promove a criatividade, a multiculturalidade,
              a vida saudável, que se preocupa com os seus alunos e que tudo faz
              para que aqui obtenham uma formação integral. Sobretudo, o IPB é
              uma comunidade que confia nos seus alunos e que se orgulha deles.
            </p>
