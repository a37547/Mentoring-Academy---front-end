        ...
        <Col xs={12} md={6} className="text-center">
          ...
          <div className="text-justify">
            ...
            <p>
              ...
              atividade mineira de exploração de cobre, arsénio e ouro,
              praticada pelos povos da idade do bronze e perpetuada pelos
              romanos que deixaram também marcas da sua ocupação na região. São
              também exemplo os pelourinhos, as pontes, as igrejas e os
